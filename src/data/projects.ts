      ...
      workstreams: [
        {
          ...
          outcome:
            "The system now underpins the Account Opening SDK, FirstDirect 2.0 Mobile, and Diaspora Banking. Every screen in the three case studies below is drawn from it — the navy and gold, the state-driven inputs, the stepper, the status chips are all the same components, specified once.",
          showcase: {
            ...
            sections: [
              {
                ...
                bodyText:
                  "Not a component library sitting apart from the product. The float account balance block, the switch-account control carrying eight organizations, the Action/Approval Center CTA, the BVN and NIN retrieval instructions, the OTP entry, the status chips, and the five-step stepper — these are the pieces the other three workstreams are assembled from, shown here as one set.",
                layout: "single",
            ...
            sections: [
              {
                ...
                sourcing: "sourced",
                bodyText:
                  "This didn't start at a screen, and it wasn't linear. Across 10+ sessions, three did the structural work: a BRD alignment with 8 team leads, a co-design session that put 100+ stakeholders in one room, and a physical workshop with 15 designers where I presented wireframes and flows — that's where the conversation stopped being about account opening and became about the whole journey. Demo day was a company-wide retreat in front of directors and MDs from every region, and it didn't end there: a 12-person post-demo iteration turned executive feedback into sprint work.",
                layout: "themedShot",
                themed: {
              ...
              },
              {
                ...
                bodyText:
                  "Two decisions carry this flow. The first is at entry: the system already knows its own context, so nobody picks a country or an account type from a menu before they've even started. The second is at NIN/BVN — verification runs directly against First Bank's own portal, because the bank checking its own records doesn't need a separate manual backend script the way an outside integrator would. Three checkpoints hang off the path at the points where real life interrupts.",
                layout: "wideShot",
              ...
              },
              {
                ...
                sourcing: "sourced",
                bodyText:
                  "Six branches. Every leaf here is a real screen — the ones in this section are drawn from it. The structure is the reusable part: this is what gets instantiated whether someone opens an account on the website, in the mobile app, or with an RM sitting next to them at a branch.",
                layout: "single",
              ...
              },
              {
                ...
                bodyText: "Photo ID, proof of address, signature, and reference each get their own card with a plain-language reason it's needed, not just a bare checklist. A hard rule sits below all four: original ID photos only, no scans or photocopies, stated once instead of repeated per document.",
                layout: "single",
        ...
        },
        {
          ...
          showcase: {
            ...
            sections: [
              ...
              {
                heading: "One login, eight organizations — this is the subsidiary management surface",
                tag: "More",
        ...
        },
        {
          ...
          showcase: {
            ...
            stats: [
              ...
              { value: "2 paths", label: "Have a BVN, or don't — both are planned for, not just the first one" },
            ],
            sections: [
              {
                ...
                sourcing: "sourced",
                bodyText:
                  "The September 2022 BRD already anticipated the applicant without a BVN: a screen was meant to pop up, and \"customers in the diaspora would be advised to visit any of the BVN centers for enrolment\" — the document even links the NIBSS list of enrollment centers abroad. So the requirement was real and it was written down. What shipped against it was a button. The analytics said roughly 70% of these applicants never got past that step, and fifteen months later the December 2023 CxO journey review still lists \"difficulty in BVN enrollment\" as an open issue for diaspora customers. Being told to visit a center is not the same as being told which center, where, and when it opens.",
                layout: "steps",
                steps: [
                  {
                    title: "Sept 2022 BRD states the requirement",
                    detail:
                  ...
                  {
                    title: "Dec 2023: still an open issue",
                    detail:
                      "The CxO journey review lists \"difficulty in BVN enrollment\" under Account Opening, owned by Diaspora Banking — recommending partnership with vendors and super agents for enrolment.",
                  },
                  {
                    title: "Answer the question the requirement actually asked",
                    detail:
                      "Not \"do you have a BVN\" but \"where do you go, and can you leave and come back?\" — country selector, real centers with addresses and opening hours, and save-and-resume.",
                    kind: "decision",
                  },
                  {
            ...
            footerStats: [
              { value: "70%", label: "Drop-off rate for older diaspora applicants before this redesign" },
              { value: "Two real paths", label: "Have a BVN and don't know it, or don't have one at all — each with its own guidance, not one generic error state" },
        ...
        sections: [
          {
            groupHeading: {
              ...
              body: "This is where a business sees everything at once — live task locations on a map, delivery creation, rider and hub management, and account settings — filtered by Intrastate, Interstate, or International scope.",
            },
          ...
          },
          {
            ...
            bodyText: "\"It may take 2 to 10 minutes before we can find a dispatch company, keep checking link\" is a real, set-expectations-plainly loading state, not a spinner with no explanation. This matters on the kind of variable mobile connections common across the markets Sharply operates in — a partner refreshing a link needs to know whether to keep waiting or come back later.",
            layout: "compare",
            columns: [
